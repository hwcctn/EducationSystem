  ...
  <el-dialog title="修改信息" v-model="ischange" width="80%"  v-if="info">
      <el-form ref="form" :model="info" label-width="80px">
        ...
        <el-form-item label="major:">
          <el-input v-model="info.role.major"></el-input>
        </el-form-item>
...
import { GetUserInfo, UpdateStudentInfo } from '@/api/user';
...
async function xiu() {
  try {
    console.log(info.value?.role.id);
  let res = await UpdateStudentInfo({
    ...
    major: info.value?.role.major as string,
